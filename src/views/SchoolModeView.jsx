            ...
            : (analysis.flashcards ?? []).map((f, i) => (
                <div key={i} className="border border-surface-200 rounded-xl overflow-hidden">
                  <div className="bg-violet-50 px-4 py-2 flex items-center justify-between">
                    <span className="text-xs font-semibold text-violet-700">Front</span>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-ink-900">📚 School Mode</h2>
          <p className="text-sm text-ink-500 mt-0.5">
            Paste a lecture transcript or notes — AI extracts what matters.
          </p>
        </div>
        <div className="text-xs px-3 py-1.5 bg-violet-100 text-violet-700 rounded-full font-semibold border border-violet-200">
            ...
            : (
              <div className="flex flex-col items-center justify-center h-64 text-center gap-3 bg-surface-50 rounded-2xl border border-dashed border-surface-300">
                ...
                <p className="text-sm text-ink-500">
                  Paste a transcript on the left to analyse your first session.
                </p>
              </div>
            )
          }
